...
def eval_libero(args: Args) -> None:
    ...
    run_id = f"EVAL-{Args.task_suite_name}-{Args.model_family}"
    ...
    checkpoint_dir = "/mnt/nfs/Users/jerry007005/model/openpi/pi05_libero"
    client = policy_config.create_trained_policy(config, checkpoint_dir)
